...
if("FALSE" STREQUAL "TRUE")
  set(baxter_moveit_config_SOURCE_PREFIX /home/ashis/catkin_ws/src/moveit_robots/baxter/baxter_moveit_config)
  set(baxter_moveit_config_DEVEL_PREFIX /home/ashis/catkin_ws/devel)
  ...
  set(baxter_moveit_config_INSTALL_PREFIX /home/ashis/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'baxter_moveit_config' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'MoveIt Setup Assistant <assistant@moveit.ros.org>, Rethink Robotics Inc. <rsdk.support@rethinkrobotics.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'baxter_moveit_config' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ashis/catkin_ws/install/${idir}'.  Ask the maintainer 'MoveIt Setup Assistant <assistant@moveit.ros.org>, Rethink Robotics Inc. <rsdk.support@rethinkrobotics.com>' to fix it.")
    endif()
